"""
1st Phorm Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from 1st Phorm.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/1st-phorm
"""
...
# Set your Web Scraper ID after building your 1st Phorm scraper:
# https://brightdata.co.kr/products/web-scraper/1st-phorm
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your 1st Phorm scraper at: https://brightdata.co.kr/products/web-scraper/1st-phorm\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of 1st Phorm product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover 1st Phorm products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a 1st Phorm category page.

    Example:
        results = discover_by_category("https://1stphorm.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.1stphorm.com/product/sample-item-123456",
        # Add more 1st Phorm product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "1st-phorm_prices.json"
    ...
    # cat_results = discover_by_category("https://1stphorm.com/category/sample", limit=50)
